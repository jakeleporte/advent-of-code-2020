...
(define (process-rules rules)
  (define peg-rules
    (regexp-substitute/global #f "8: 42" rules
  			      'pre "8: 42 | 42 8" 'post))
  (set! peg-rules
    (regexp-substitute/global #f "11: 42 31" peg-rules
  			      'pre "11: 42 31 | 42 11 31" 'post))
  (set! peg-rules
    (regexp-substitute/global #f " ([0-9 ]+) \\| ([0-9 ]+)" peg-rules
			      'pre " (" 1 ") / (" 2 ")" 'post))
  (set! peg-rules
